...
export default function ProfissionaisPage() {
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell className="px-4 py-4 font-normal text-gray-800 border border-gray-100 dark:border-white/[0.05] text-theme-sm dark:text-white/90 whitespace-nowrap">
                      <div className="flex items-center w-full gap-2">
                        <button className="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500"><BiTrash className="size-5" /></button>
                        <button className="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90"><BiPencil className="size-5" /></button>
                      </div>
                    </TableCell>
                  </TableRow>
                ))}
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="pb-3 xl:pb-0">
              <p className="pb-3 text-sm font-medium text-center text-gray-500 border-b border-gray-100 dark:border-gray-800 dark:text-gray-400 xl:border-b-0 xl:pb-0 xl:text-left">
                Exibindo {startIndex + 1} a {endIndex} de {totalEntries} linhas
              </p>
            </div>
  ...
  function qtdLinhas() {
    return <>
      <span className="text-gray-500 dark:text-gray-400"> Exibir </span>
      ...
      <span className="text-gray-500 dark:text-gray-400"> linhas </span>
    </>
  }
