...
export default function SignInForm() {
  ...
  const delay: DelayFunction = (ms: number): Promise<void> => {
        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Entre com seu email e senha para se logar!
            </p>
          </div>
          <div>
            ...
            <form onSubmit={handleLogin}>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input placeholder="seuemail@email.com" value={email} onChange={(e) => setInputUsername(e.target.value)} />
                </div>
                <div>
                  <Label>
                  ...
                  <div className="relative">
                    <Input type={showPassword ? "text" : "password"} placeholder="Entre com a senha" value={senha} onChange={(e) => setInputPassword(e.target.value)} />
                    <span
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/reset-password" onClick={handlePassword} className="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">
                    Esqueceu a senha?
                  </Link>
                </div>
                <div>
                  <Button className="w-full" size="sm" >Logar</Button>
                </div>
              </div>
            </form>
